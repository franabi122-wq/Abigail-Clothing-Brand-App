...
Check-out Page:
![alt text](<Checkout page.png>)

Order Success Screen:
![alt text](<Order Success Page.png>)

Order History Page:
![alt text](<Order History Page.png>)
...
![alt text](SupaBase_products_table_schema.png)
